...
namespace FORM
{
    public partial class FRM_TMS_VJ3VJ2_WS : Form
    {
        ...
        private void BindingQty2AsyDate(string ARG_DATE, string ARG_PLANT)
        {
            ...
            try
            {
                ...
                if (dtTripTime.Rows.Count > 0 && dtTripTime != null)
                {
                    ...
                    btnS_VJ3VJ1_Time.Text = string.IsNullOrEmpty(dtTripTime1.Rows[0]["S_TIME"].ToString()) ? "" : dtTripTime1.Rows[0]["S_TIME"].ToString().Replace("::", "");
                    btnE_VJ3VJ1_Time.Text = string.IsNullOrEmpty(dtTripTime1.Rows[0]["E_TIME"].ToString()) ? "" : dtTripTime1.Rows[0]["E_TIME"].ToString().Replace("::", "");
                ...
                if (dt != null && dt.Rows.Count > 0)
                {
                    ...
                    lb2_total.Text = btnCar2.Text = string.Format("{0:n0}", dt2.Rows[0]["TOTAL"]);
        ...
        private void BindingData2Grid(string ARG_DATE,string ARG_PLANT)
        {
            try
            {
                ...
                if (dt != null && dt.Rows.Count > 0)
                {
                    ...
                    DataTable dt2 = dt.Select("DIV = 'VJ2_WS'").CopyToDataTable();
                    grdBase1.DataSource = dt2;
                    gvwBase1.Columns[0].AppearanceHeader.BackColor = Color.FromArgb(128, 128, 128);
                    gvwBase1.Columns[0].AppearanceHeader.BackColor2 = Color.FromArgb(128, 128, 128);
                    gvwBase1.Columns[0].AppearanceHeader.ForeColor = Color.White;
                    gvwBase1.Columns[3].AppearanceHeader.BackColor = Color.FromArgb(128, 128, 128);
                    gvwBase1.Columns[3].AppearanceHeader.BackColor2 = Color.FromArgb(128, 128, 128);
                    gvwBase1.Columns[3].AppearanceHeader.ForeColor = Color.White;
                    gvwBase1.Columns[4].AppearanceHeader.BackColor = Color.FromArgb(128, 128, 128);
                    gvwBase1.Columns[4].AppearanceHeader.BackColor2 = Color.FromArgb(128, 128, 128);
                    gvwBase1.Columns[4].AppearanceHeader.ForeColor = Color.White;
                    gvwBase1.Columns[5].AppearanceHeader.BackColor = Color.FromArgb(128, 128, 128);
                    gvwBase1.Columns[5].AppearanceHeader.BackColor2 = Color.FromArgb(128, 128, 128);
                    gvwBase1.Columns[5].AppearanceHeader.ForeColor = Color.White;
                    gvwBase1.Columns[6].AppearanceHeader.BackColor = Color.FromArgb(128, 128, 128);
                    gvwBase1.Columns[6].AppearanceHeader.BackColor2 = Color.FromArgb(128, 128, 128);
                    gvwBase1.Columns[6].AppearanceHeader.ForeColor = Color.White;
                    gvwBase1.Columns[7].AppearanceHeader.BackColor = Color.FromArgb(57, 190, 29);
                    gvwBase1.Columns[7].AppearanceHeader.BackColor2 = Color.FromArgb(57, 190, 29);
                    gvwBase1.Columns[7].AppearanceHeader.ForeColor = Color.White;
                    gvwBase1.Columns[8].AppearanceHeader.BackColor = Color.FromArgb(255, 127, 0);
                    gvwBase1.Columns[8].AppearanceHeader.BackColor2 = Color.FromArgb(255, 127, 0);
                    gvwBase1.Columns[8].AppearanceHeader.ForeColor = Color.White;
                    for (int i = 0; i < gvwBase1.Columns.Count; i++)
                    {
                        ...
                        gvwBase1.Columns["TRIP"].Visible = true;
                        gvwBase1.Columns["DIV"].Visible = false;
                        gvwBase1.Columns["LINE"].Width = 100;
                        gvwBase1.Columns["SET"].Width = 250;
                        gvwBase1.Columns["MODEL"].Width = 500;
                        gvwBase1.Columns["START TIME"].Visible = false;
                        gvwBase1.Columns["ARRIVAL TIME"].Visible = false;
                        gvwBase1.Columns["LINE_CD"].Visible = false;
                        gvwBase1.Columns["MLINE_CD"].Visible = false;
                        gvwBase1.Columns["SET_RATIO"].Visible = false;
                        if (VThread.Equals("DEPART"))
                        {
                            gvwBase1.Columns["INCOMING QTY"].Caption = "UPPER OUTGOING";
                            gvwBase1.Columns["COMPONENT"].Visible = false;
                        }
                        else
                        {
                            gvwBase1.Columns["INCOMING QTY"].Caption = "INCOMING QTY";
                            gvwBase1.Columns["COMPONENT"].Visible = true;
                        }
                    }
        ...
        private void gvwBase1_CellMerge(object sender, DevExpress.XtraGrid.Views.Grid.CellMergeEventArgs e)
        {
            try
            {
                if (e.RowHandle1 < 0 || gvwBase.RowCount == 0)
                ...
                if (e.Column.FieldName == "TRIP")
                {
                    string line1 = gvwBase1.GetRowCellValue(e.RowHandle1, "TRIP").ToString().Trim();
                    string line2 = gvwBase1.GetRowCellValue(e.RowHandle2, "TRIP").ToString().Trim();
                    if (line1 == line2)
                    {
                        e.Merge = true;
                    }
                ...
                if (e.Column.FieldName == "LINE")
                {
                    string line1 = gvwBase1.GetRowCellValue(e.RowHandle1, "LINE").ToString().Trim();
                    string line2 = gvwBase1.GetRowCellValue(e.RowHandle2, "LINE").ToString().Trim();
                ...
                if (e.Column.FieldName == "SET")
                {
                    string line1 = gvwBase1.GetRowCellValue(e.RowHandle1, "LINE").ToString().Trim();
                    string line2 = gvwBase1.GetRowCellValue(e.RowHandle2, "LINE").ToString().Trim();
                    string set1 = gvwBase1.GetRowCellValue(e.RowHandle1, "SET").ToString().Trim();
                    string set2 = gvwBase1.GetRowCellValue(e.RowHandle2, "SET").ToString().Trim();
                    string trip1 = gvwBase1.GetRowCellValue(e.RowHandle1, "TRIP").ToString().Trim();
                    string trip2 = gvwBase1.GetRowCellValue(e.RowHandle2, "TRIP").ToString().Trim();
                    string STYLE1 = gvwBase1.GetRowCellValue(e.RowHandle1, "STYLE").ToString().Trim();
                    string STYLE2 = gvwBase1.GetRowCellValue(e.RowHandle2, "STYLE").ToString().Trim();
                    if (set1 == set2 && trip1 == trip2 && STYLE1 == STYLE2 && line1 == line2)
                    {
                        e.Merge = true;
                    }
                ...
                if (e.Column.FieldName == "MODEL")
                {
                    string trip1 = gvwBase1.GetRowCellValue(e.RowHandle1, "LINE").ToString().Trim();
                    string trip2 = gvwBase1.GetRowCellValue(e.RowHandle2, "LINE").ToString().Trim();

                    string model1 = gvwBase1.GetRowCellValue(e.RowHandle1, "MODEL").ToString().Trim();
                    string model2 = gvwBase1.GetRowCellValue(e.RowHandle2, "MODEL").ToString().Trim();
                    if (trip1 == trip2 && model1 == model2)
                    {
                        e.Merge = true;
                    }
        ...
        private void gvwBase1_RowCellStyle(object sender, DevExpress.XtraGrid.Views.Grid.RowCellStyleEventArgs e)
        {
            try
            {
                if (e.Column.FieldName == "SET")
                {
                    if (gvwBase1.GetRowCellValue(e.RowHandle, "SET").ToString().Contains("100%"))
                    {
                ...
                {
                    if (!VThread.Equals("DEPART"))
                        if (gvwBase1.GetRowCellValue(e.RowHandle, "COMPONENT").ToString().ToUpper().Contains("UPPER"))
                        {
        ...
        private void gvwBase1_RowCellClick(object sender, DevExpress.XtraGrid.Views.Grid.RowCellClickEventArgs e)
        {
            ...
            FRM_TMS_CAR_LT_POP pop = new FRM_TMS_CAR_LT_POP();
            pop.v_date = DateTime.Now.ToString("yyyyMMdd");
            pop.v_Trip = gvwBase1.GetRowCellValue(e.RowHandle, "TRIP").ToString();
            pop.v_STYLE_CD = gvwBase1.GetRowCellValue(e.RowHandle, "STYLE").ToString();
            //    pop.LINE = LINE;
            pop.v_LINE_CD = gvwBase1.GetRowCellValue(e.RowHandle, "LINE_CD").ToString();
            pop.v_MLINE_CD = gvwBase1.GetRowCellValue(e.RowHandle, "MLINE_CD").ToString();
